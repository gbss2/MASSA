...
public class BioData implements java.io.Serializable {
	...
	/* Start Create Instance, SetTtem and getList for BioData Objects */
	...
	/* End Create Instance, SetTtem and getList for BioData Objects */
	...
	public String SnpGenetoString(Gene g) { // Create a method to print
											// variables of the class
		return "Gene Symbol = " + g.getGeneSymbol() + "\nSNP id = " + g.getSnpid();
	}
	...
	public String toString(Gene gene) { // Create a method to print variables of
										// the class

		return "Gene Name = " + gene.getGeneName() + "\nGene Symbol = " + gene.getGeneSymbol() + "\nGene Alt Symbol = "
				+ gene.getGeneAltSymbol() + "\nChromosome = " + polymorphism.getChromosome() + "\nPolymorphism Code = "
				+ polymorphism.getPolymorphismCode() + "\nKind = " + polymorphism.getKind() + "\nSub-Kind = "
				+ polymorphism.getSubKind();
	}

	// Method for return Basic Provenance
	...
	// Method for return Complete Provenance
	public void setCompleteProvenance() {
		 ...
		 * Orientation 11. Assembly Build Version 12. Assembly Coord Start 13.
		 * Assembly Coord End 14. mRNA accession 15. mRNA version 16. Alleles
		 * 17. Frequency 18. Strand 19. RefUCSC 20. ObservedUCSC 21.
		 * Polymorphism Class 22. Functional Class 23. Pathway list 24. Drug
		 * list 25. Disease list 26. Genex list 27. GO Molecular Function 28. GO
		 * Cellular Component 29. GO Biological Process 30. Cytoloc 31. Gene
		 * Status 32. Gene Map Methods 33. Disorders 34. MIM ids 35. Inheritance
		 * 36. Pheno Map Methods 37. Comments
		 */
		// dbSNP
		provenance_attrib.put("Polymorphism Id", "dbsnp");
		provenance_attrib.put("Polymorphism Type", "dbsnp");
	...
	public void setDataProvenanceLink() {
		...
		/*
		 * LIST OF DATABASES 1. dbSNP 2. pharmGKB - Pharmacogenetics Knowledge
		 * Database 3. GO - Gene Ontology 4. OMIM - Online Mendelian Inheritance
		 * in Man 5. HGNC - Hugo Gene Nomenclature Committee 6. UCSC - UCSC
		 * Genome Browser description 7. UCSC - UCSC Genome Browser tables
		 * description (deprecated) 8. UCSC - UCSC Genome Browser tables
		 * phastCons/phyloP
		 * 
		 */
		...
		provenance_link.put("ucsc",
				"http://genome.ucsc.edu/goldenPath/help/hgTracksHelp.html, http://hgdownload.cse.ucsc.edu/downloads.html#human");
