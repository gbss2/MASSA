	...
	public static void LaunchMainContainer(Runtime rt){
		...
		if (getAnalysistype() == 2){   // remote analysis
			...
			for (int i = 1; i <= (getPquery()+2); i++) {
				try{
					...
					AgentController dbsnpagent = cont.createNewAgent(dbsnpagent_name,"massa.agents.DBsnpAgent", new Object[0]);
					dbsnpagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
		...
		if (getAnalysistype() == 4){   // remote comlete analysis
			...
			for (int i = 1; i <= (getPquery()+2); i++) {
				...
				try{
					...
					AgentController goagent = cont.createNewAgent(goagent_name,"massa.agents.GOAgent", new Object[0]);
					goagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController pharmgkbagent = cont.createNewAgent(pharmagent_name,"massa.agents.PharmgkbAgent", new Object[0]);
					pharmgkbagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController ucscagent = cont.createNewAgent(ucscagent_name,"massa.agents.UCSCAgent", new Object[0]);
					ucscagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController omimagent = cont.createNewAgent(omim_name,"massa.agents.omimAgent", new Object[0]);
					omimagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController hugoagent = cont.createNewAgent(hugo_name,"massa.agents.HGNCAgent", new Object[0]);
					hugoagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
		...
		if (getAnalysistype() == 1){   // local analysis
			...
			for (int i = 1; i <= (getPquery()+2); i++) {
				try{
					dbsnpagent_name = "dbsnp"+Integer.toString(i);
					AgentController dbsnpagent = cont.createNewAgent(dbsnpagent_name,"massa.agents.DBsnpLocalAgent", new Object[0]);
					dbsnpagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
		...
		if (getAnalysistype() == 3){   // local complete analysis
			...
			for (int i = 1; i <= (getPquery()+2); i++) {
				...
				try{
					goagent_name = "geneontology"+Integer.toString(i);
					AgentController goagent = cont.createNewAgent(goagent_name,"massa.agents.GOLocalAgent", new Object[0]);
					goagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					pharmagent_name = "pharmgkb"+Integer.toString(i);
					AgentController pharmagent = cont.createNewAgent(pharmagent_name,"massa.agents.PharmgkbLocalAgent", new Object[0]);
					pharmagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					omim_name = "omim"+Integer.toString(i);
					AgentController omimagent = cont.createNewAgent(omim_name,"massa.agents.omimLocalAgent", new Object[0]);
					omimagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					ucscagent_name = "ucsc"+Integer.toString(i);
					AgentController ucscagent = cont.createNewAgent(ucscagent_name,"massa.agents.UCSCLocalAgent", new Object[0]);
					ucscagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					hugo_name = "hugo"+Integer.toString(i);
					AgentController hugoagent = cont.createNewAgent(hugo_name,"massa.agents.HGNCLocalAgent", new Object[0]);
					hugoagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController gwasagent = cont.createNewAgent(gwas_name,"massa.agents.GWAScatalogLocalAgent", new Object[0]);
					gwasagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController polyphenagent = cont.createNewAgent(polyphen_name,"massa.agents.PolyphenLocalAgent", new Object[0]);
					polyphenagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController proveanagent = cont.createNewAgent(provean_name,"massa.agents.ProveanLocalAgent", new Object[0]);
					proveanagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				try{
					...
					AgentController reactomeagent = cont.createNewAgent(reactome_name,"massa.agents.reactomeLocalAgent", new Object[0]);
					reactomeagent.start();
				}
				catch(StaleProxyException ie) {
					ie.printStackTrace();
				...
				// SIFT agent
//				try{
//					sift_name = "sift"+Integer.toString(i);
//					AgentController siftagent = cont.createNewAgent(sift_name,"diverenrich.SIFTLocalAgent", new Object[0]);
//					siftagent.start();
//				}
//				catch(StaleProxyException ie) {
//					ie.printStackTrace();
//				}
		...
		// SnpToGene agent
		try{
			AgentController dbsnpagent = cont.createNewAgent("snptogene","massa.agents.SnpToGeneAgent", new Object[0]);
			dbsnpagent.start();
		}
		catch(StaleProxyException ie) {
			ie.printStackTrace();
		...
		// Coordinator agent
		try{
			AgentController coordinatoragent = cont.createNewAgent("coordinator","massa.agents.CoordinatorAgent", new Object[0]);
		...
		// Interface agent
		try{
			AgentController interfaceagent = cont.createNewAgent("interface","massa.agents.InterfaceAgent", new Object[0]);
